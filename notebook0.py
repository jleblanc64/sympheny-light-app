...
WZ_CSS = """
<style>
/* remove only the default TOP spacing above the first output (keeps left/right margins intact) */
html,body{margin-top:0 !important;padding-top:0 !important}
#rendered_cells,#main,#site,.jp-Notebook,.jp-NotebookPanel,.voila-app,#voila-container,
.jp-WindowedPanel-outer,.jp-WindowedPanel-inner{margin-top:0 !important;padding-top:0 !important}
.jp-Cell,.jp-Cell-outputWrapper,.jp-CodeCell,.jp-OutputArea,.jp-OutputArea-child,
.jp-OutputArea-output,.jp-Notebook-cell{margin-top:0 !important;padding-top:0 !important}
.widget-vbox,.widget-html,.jp-RenderedHTMLCommon{margin-top:0 !important}
.widget-vbox:first-child,.widget-html:first-child,.jp-RenderedHTMLCommon:first-child{margin-top:0 !important}
...
/*nav*/ .wz-nav{--c:#dbe3ec;background:#1b2534 !important;border-radius:10px;padding:0 14px;height:72px;display:flex;align-items:center;gap:4px;margin:0 0 14px}.wz-nav .crumb{display:flex;align-items:center;gap:11px;padding:9px 16px;font-size:16px;border-radius:24px}.wz-nav .crumb.done{--c:#f0f4f8}.wz-nav .crumb.active{--c:#fff;font-weight:700;background:rgba(255,255,255,.14)}.wz-nav .sep{--c:#9aa7b8;font-size:15px;padding:0 2px}.wz-nav .dot{--c:#fff;flex:0 0 30px;width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#5a6a7e;font-size:14px;font-weight:700}.wz-nav .crumb.done .dot{background:var(--teal)}.wz-nav .crumb.active .dot{background:var(--teal);box-shadow:0 0 0 3px #0f9d8f55}.wz-nav .user{--c:#dbe3ec;margin-left:auto;padding:0 2px;font-size:16px;white-space:nowrap}.wz-nav .user b{--c:#fff;font-weight:600}
